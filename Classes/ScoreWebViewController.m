...
- (void)loadView
{
	...
	UIView *cView = [[[NSBundle mainBundle] loadNibNamed:@"EmailView" owner:self options:nil] lastObject ];
...
*/
	...
	NSString *str=[NSString stringWithFormat:@"http://www.golfmemoir.com/index.php?panel=fromScorelist-%i-%@", mScore.serverpk, [[UIDevice currentDevice] uniqueIdentifier]];
